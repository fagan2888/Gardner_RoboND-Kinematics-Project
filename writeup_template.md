...
Individual transformation matrices (item 5) were completed for each joint as per Denavit–Hartenberg convention as seen for a serial robot arm having 6 DOF. The matrix convention Figure 3 below allows each joint to be define in the DH syntax. 
